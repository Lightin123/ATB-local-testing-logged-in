            ...
            <Popover open={props.isOpen} onOpenChange={props.onOpenChange}>
                ...
                <PopoverContent ref={contentRef} className="w-full">
                    <div {...dialogProps} className="space-y-3">
                        ...
                        {state.hasTime && <TimeField value={state.timeValue} aria-label={"time-field"} onChange={state.setTimeValue} />}
                    </div>
                </PopoverContent>
            </Popover>
            <DateField {...fieldProps} aria-label={"date-field"} value={currentValue()} />
            <div className={cn('-ml-2 mr-2 h-5 w-5', !showClearButton && 'hidden')}>
                <X
                    className={cn('h-5 w-5 cursor-pointer text-muted-foreground/60', !jsDatetime && 'hidden')}
                    onClick={() => {
                        setJsDatetime(null);
                        onJsDateChange?.(null);
                    }}
