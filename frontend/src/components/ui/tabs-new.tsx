...
const TabsItem = ({
    ...
    return (
        <div
            ...
            onClick={onClick}
            className={cn(
                "flex gap-2 items-center cursor-pointer rounded-t-md text-muted-foreground font-500 px-4 py-2 border-b-2 border-transparent hover:muted-foreground transition-colors data-[active='true']:border-primary data-[active='true']:text-primary hover:bg-secondary",
                className
            )}
            {...domProps}
        >
