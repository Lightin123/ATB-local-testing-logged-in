    ...
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogPortal>
          ...
          <DialogContent
            className="fixed top-1/2 left-1/2 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-md bg-background p-6 shadow-lg"
            aria-describedby="maintenance-desc"
          >
            <DialogTitle>Report Maintenance</DialogTitle>
            <DialogDescription id="maintenance-desc">
              Use this form to submit a maintenance request.
            </DialogDescription>
            <MaintenanceForm
              mode={mode}
